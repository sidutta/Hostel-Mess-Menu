		...
		$
				.ajax({
					...
					success : function(data, textStatus, jqXHR) {
						...
						//$("#table").empty();
						obj = JSON.parse(data);
						var bfastArray=obj.bfast;
						var lunchArray=obj.lunch;
						var tiffinArray=obj.tiffin;
						var dinnerArray=obj.dinner;
						var bfasttxt="";
						var lunchtxt="";
						var tiffintxt="";
						var dinnertxt="";
...
<form class="col-lg-3">
<center>
<div class="form-group"><select class="combobox form-control"name="hostelnum" >
