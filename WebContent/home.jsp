...
<table id="table" class="table">
	<tr>
		...
		<td>
		<%
					ArrayList<String> bfast = (ArrayList<String>) session
							.getAttribute("bfast");
					if (bfast.isEmpty()) {
				%> Data Not Available <%
					} else {
	...
	<tr>
		...
		<td>
		<%
					ArrayList<String> lunch = (ArrayList<String>) session
							.getAttribute("lunch");
					if (lunch.isEmpty()) {
				%> Data Not Available <%
					} else {
	...
	<tr>
		...
		<td>
		<%
					ArrayList<String> tiffin = (ArrayList<String>) session
							.getAttribute("tiffin");
					if (tiffin.isEmpty()) {
				%> Data Not Available <%
					} else {
	...
	<tr>
		...
		<td>
		<%
					ArrayList<String> dinner = (ArrayList<String>) session
							.getAttribute("dinner");
					if (dinner.isEmpty()) {
				%> Data Not Available <%
					} else {
...
<form class="col-lg-3">
<center>
<div class="form-group"><select class="combobox form-control" id="hostelnum" >
