...
<body>
	...
	<h1>
		<center>
			Welcome
			<%=request.getAttribute("consumername")%></center>
	</h1>

	<form action="Othermenu" method="get">
		<center>
			Change Hostel <select name="hostelnum">
			...
			</select> <input type="submit" value="Change"> <input type="hidden"
				name="consumername" value=<%=request.getAttribute("consumername")%>>
		</center>
	</form>
	<br>

	<h2>
		<center><%=request.getAttribute("hostelnumber")%>: Today's
			Menu
		</center>
	</h2>
	<h3>Breakfast</h3>
